...
public class FanSpeedNumDialog extends AppCompatDialogFragment {
    ...
    private FanSpeedNumDialog.FanSpeedNumDialogListener listener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fan_speed_dialog, null);
    ...
    public void onAttach(Context context) {
        ...
        listener = (FanSpeedNumDialog.FanSpeedNumDialogListener) context;
    }
